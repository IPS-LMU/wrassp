...
package. `wrassp` is a **w**rapper for **R** around Michel Scheffer's [libassp](http://libassp.sourceforge.net/)
...
functions in a (hopefully) user-friendly manner.
...
# (only plot every 10th element to accelarate plotting)
...
For questions that might have already been answered or if you have an 
