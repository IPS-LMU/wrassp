...
`wrassp` is of course capable of a lot more than just the mere reading or writing 
of signal files. Next we will use `wrassp` to calculate the formant values,
